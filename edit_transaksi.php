...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE transaksi SET transaction_date='$transaction_date',produk='$produk',kategori='$kategori' WHERE id='$id'";
  ...
  foreach ($query as $data) {
	...
	<div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
						<textarea class="form-control" name="kategori" rows="3" required=""><?= $data['kategori'] ?></textarea>
                    </div>
                </div>
                </div>
