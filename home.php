<div class="mb-4">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 style="background-color: grey;" class="h3 mb-0 text-white"><i class="fas fa-fw fa-home"></i> Dashboard</h1>
  </div>
      ...
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="index.php?menu=data_transaksi" class="text-secondary text-decoration-none">Data Pinjaman</a></div>
            </div>
            <div class="col-auto">
  ...
  <div class="col-xl-4 col-md-6 mb-4">
    <div class="card border-left-secondary shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="index.php?menu=hasil" class="text-secondary text-decoration-none">Denda Buku</a></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-coins fa-2x text-gray-300"></i>
          </div>
