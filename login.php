...
<html>
    ...
    <body style="background-image :  url('img/2.jpeg'); background-size: cover; ">

            <div class="container">
                <a class="navbar-brand" style="font-weight: 900;" href="index.php"> <i class="fa  mr-2 rotate-n-15"></i></a>
            </div>
        </nav>
