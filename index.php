...
?>
	  ...
	  ?>">
	    ...
	    <li class="nav-item <?php echo ($menu_active == 'proses_apriori') ? "active" : ""; ?>">
      <a class="nav-link" href="index.php?menu=denda">
        <i class="fas fa-fw fa-book"></i>
     
          <span>Denda Buku</span></a>
      </li>
	  
   

      <li class="nav-item <?php echo ($menu_active == 'proses_apriori') ? "active" : ""; ?>">
      <a class="nav-link" href="index.php?menu=cari">
        <i class="fas fa-fw fa-coins"></i>
      ...
      <li class="nav-item <?php echo ($menu_active == 'proses_apriori') ? "active" : ""; ?>">
      <a   class="nav-link" href="index.php?menu=member">
        <i class="fas fa-fw fa-coins"></i>
          <span>Angota Perpustakaan</span></a>
      </li>
      <!-- Divider -->
    ...
    <!-- Content Wrapper -->
    <div style="background-image :  url('img/2.jpeg'); background-size: cover; " id="content-wrapper" class="d-flex flex-column">
